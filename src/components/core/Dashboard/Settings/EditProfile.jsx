            ...
            <div className="flex flex-col gap-2 lg:w-[48%]">
              ...
              <input
                ...
                {...register("dateOfBirth", {
                  ...
                  max: {    //!IMPORTANT
                    value: new Date().toISOString().split("T")[0],//get the current date in YYYY-MM-DD format. split is used to split date and time and [0]->date
            ...
            <div className="flex flex-col gap-2 lg:w-[48%]">
              ...
              <input
                ...
                {...register("contactNumber", {
                  ...
                  maxLength: { value: 13, message: "Invalid Contact Number" },
